...
class Welcome(commands.Cog):
    ...
    async def get_used_invite(self, guild):
        """Checks which invite is used in join via the following:
    ...
    @commands.command()
    async def swelcome(self, ctx, channel: discord.TextChannel, *, message):
        """Sets up welcome command. You can ask Neko for Advanced Info.
             For help, visit [This Page](https://github.com/Abadima/modmail-plugins/blob/master/welcome/README.md)
        """
    ...
    async def on_member_join(self, member):
        ...
        if config:
            ...
            if channel:
                ...
                print('Welcome Not Found: {getattr(channel, "id", None}')
